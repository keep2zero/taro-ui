...
import { AtLine } from '../../../components/items/index'
// import AtForm from '../../../components/form/index'
import DocsHeader from '../../components/doc-header'

import './index.scss'
import AtLineInput from '../../../components/items/line-input'

export default class ButtonPage extends Taro.Component {
  config = {
    navigationBarTitleText: 'Taro UI Items'
  }
  ...
  render () {
    return (
      <View className='page'>
        {/* S Header */}
        <DocsHeader title='基本的零件'></DocsHeader>
        {/* E Header */}
        ...
        <View className='doc-body'>
          ...
          <View className='panel'>
            <View className='panel__title'>行</View>
            <View className='panel__content'>
              <View className='btn-item'>
                <AtLine prefix={{ value: 'clock', size: 90, type: 'at' }}
                  split
                  extraText='说明问题'
                  title='我是标题我是标题我是标题我是标题'
                  suffix={{ value: 'arrow', size: 20, color: '#bbb', type: 'fa' }}
              ...
              <View className='btn-item'>
                <Picker>
                  <AtLine split title='选择' suffix={{ value: 'arrow', size: 20, color: '#bbb', type: 'fa' }}></AtLine>

                </Picker>
              </View>

              <View className='btn-item'>
                <AtLineInput type='picker' desc='hello' title='label内容' split suffix={{ value: 'arrow', size: 20, color: '#bbb', type: 'fa' }}></AtLineInput>
              </View>
            </View>
          </View>
